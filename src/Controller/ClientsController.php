...
class ClientsController extends AbstractController
{
    ...
    public function add()
    {
        ...
        $services =  $em->getRepository(Services::class)->showServices(); 
        $operation =  $em->getRepository(Operation::class)->showOperation(); 
...
/**
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $serv =  $em->getRepository(Services::class)->showServices(); 
        $opr =  $em->getRepository(Operation::class)->showOperation(); 
     ...
     $counterOper =  count($opr )    ;
     $counterServ =  count($serv )    ;
     
     var_dump($counterOper);
     var_dump($counterServ);
     $devis = new Devis();
